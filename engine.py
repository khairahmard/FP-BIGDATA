...
class RecommendationEngine:
    ...
    def __train_all_model(self):
        ...
        self.als = ALS(maxIter=5, regParam=0.01, userCol="UserId", itemCol="ProductId", ratingCol="Rating",
        ...
        self.als = ALS(maxIter=5, regParam=0.01, serCol="UserId", itemCol="ProductId", ratingCol="Rating",
                  coldStartStrategy="drop")
